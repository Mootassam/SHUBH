...
common: {
  ...
  pc: {
    ...
    lots: "Lotti(Passo:0.01)",
    eachLots: "Ogni lotto",
    handlingFee: "Commissione stimata",
    estimatedMargin: "Margine stimato",
    buy: "Compra",
    sell: "Vendi",
    searchMarkets: "Cerca mercati…",
    all: "Tutti", forex: "Forex", crypto: "Cripto", metals: "Metalli", indices: "Indici",
    login: "Accedi", register: "Registrati", profile: "Profilo", logout: "Esci",
    insufficient: "Saldo insufficiente",
    confirmBuy: "Conferma acquisto", confirmSell: "Conferma vendita",
    symbol: "Simbolo", direction: "Direzione", price: "Prezzo", lotsMult: "Lotti · Mult",
    cancel: "Annulla", confirm: "Conferma", placing: "Invio…", orderPlaced: "ordine piazzato su",
    email: "Email", password: "Password", rememberMe: "Ricordami", signingIn: "Accesso…",
    demoLogin: "Accedi all'account demo", loading: "Caricamento…", phone: "Numero di telefono",
    captcha: "Captcha", enterCaptcha: "Inserisci il captcha", passwordHint: "Almeno 8 caratteri",
    confirmPassword: "Conferma password", reenterPassword: "Reinserisci la password",
    createAccount: "Crea account", creatingAccount: "Creazione account…",
    noAccount: "Nessun account?", haveAccount: "Hai già un account?",
    fillRequired: "Compila tutti i campi obbligatori.", emailPwRequired: "Email e password sono obbligatori.",
    pwMin: "La password deve contenere almeno 8 caratteri.", pwMismatch: "Le password non corrispondono.",
    captchaMismatch: "Il captcha non corrisponde.",
    kyc: "Verifica KYC", bindAccount: "Collega account", orders: "Ordini", deposit: "Deposito",
    withdraw: "Prelievo", history: "Cronologia", notifications: "Notifiche",
    onlineService: "Servizio online", aboutUs: "Chi siamo", help: "Aiuto",
    verified: "Verificato", pendingReview: "In revisione", notVerified: "Non verificato",
    completeKyc: "Completa la verifica KYC per sbloccare tutte le funzioni.",
    demoNoFeatures: "Gli account demo non possono usare queste funzioni.", back: "Indietro",
  },
};
