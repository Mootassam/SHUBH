...
common: {
  ...
  pages: {
    ...
    faq: {
      ...
      steps: {
        goToWebsite: "Gehen Sie zu https://trade-binex.com",
      ...
      footer: {
        copyright: "© 2025 BINEX. Alle Rechte vorbehalten.",
        needHelp: "Brauchen Sie mehr Hilfe? Kontaktieren Sie binex.helpdesk01@gmail.com"
      }
    },
  ...
  pc: {
    ...
    lots: "Lots(Schritt:0.01)",
    eachLots: "Pro Lot",
    handlingFee: "Geschätzte Gebühr",
    estimatedMargin: "Geschätzte Margin",
    buy: "Kaufen",
    sell: "Verkaufen",
    searchMarkets: "Märkte suchen…",
    all: "Alle", forex: "Forex", crypto: "Krypto", metals: "Metalle", indices: "Indizes",
    login: "Anmelden", register: "Registrieren", profile: "Profil", logout: "Abmelden",
    insufficient: "Unzureichendes Guthaben",
    confirmBuy: "Kauf bestätigen", confirmSell: "Verkauf bestätigen",
    symbol: "Symbol", direction: "Richtung", price: "Preis", lotsMult: "Lots · Mult",
    cancel: "Abbrechen", confirm: "Bestätigen", placing: "Wird gesendet…", orderPlaced: "Order platziert auf",
    email: "E-Mail", password: "Passwort", rememberMe: "Angemeldet bleiben", signingIn: "Anmeldung…",
    demoLogin: "Beim Demokonto anmelden", loading: "Lädt…", phone: "Telefonnummer",
    captcha: "Captcha", enterCaptcha: "Captcha eingeben", passwordHint: "Mindestens 8 Zeichen",
    confirmPassword: "Passwort bestätigen", reenterPassword: "Passwort erneut eingeben",
    createAccount: "Konto erstellen", creatingAccount: "Konto wird erstellt…",
    noAccount: "Kein Konto?", haveAccount: "Schon ein Konto?",
    fillRequired: "Bitte alle Pflichtfelder ausfüllen.", emailPwRequired: "E-Mail und Passwort sind erforderlich.",
    pwMin: "Das Passwort muss mindestens 8 Zeichen haben.", pwMismatch: "Die Passwörter stimmen nicht überein.",
    captchaMismatch: "Das Captcha stimmt nicht überein.",
    kyc: "KYC-Verifizierung", bindAccount: "Konto verknüpfen", orders: "Aufträge", deposit: "Einzahlung",
    withdraw: "Auszahlung", history: "Verlauf", notifications: "Benachrichtigungen",
    onlineService: "Online-Service", aboutUs: "Über uns", help: "Hilfe",
    verified: "Verifiziert", pendingReview: "In Prüfung", notVerified: "Nicht verifiziert",
    completeKyc: "Schließen Sie die KYC-Verifizierung ab, um alle Funktionen freizuschalten.",
    demoNoFeatures: "Demokonten können diese Funktionen nicht nutzen.", back: "Zurück",
  },
