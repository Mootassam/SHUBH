...
common: {
  ...
  pc: {
    ...
    multiplier: "Çarpan",
    setLoss: "Zarar Durdur",
    takeProfit: "Kâr Al",
    lots: "Lot(Adım:0.01)",
    eachLots: "Her lot",
    handlingFee: "Tahmini ücret",
    estimatedMargin: "Tahmini teminat",
    buy: "Al",
    sell: "Sat",
    searchMarkets: "Piyasa ara…",
    all: "Tümü", forex: "Forex", crypto: "Kripto", metals: "Metaller", indices: "Endeksler",
    login: "Giriş", register: "Kayıt ol", profile: "Profil", logout: "Çıkış",
    insufficient: "Yetersiz bakiye",
    confirmBuy: "Alımı onayla", confirmSell: "Satışı onayla",
    symbol: "Sembol", direction: "Yön", price: "Fiyat", lotsMult: "Lot · Çarpan",
    cancel: "İptal", confirm: "Onayla", placing: "Gönderiliyor…", orderPlaced: "emir verildi:",
    email: "E-posta", password: "Şifre", rememberMe: "Beni hatırla", signingIn: "Giriş yapılıyor…",
    demoLogin: "Demo hesaba giriş", loading: "Yükleniyor…", phone: "Telefon numarası",
    captcha: "Captcha", enterCaptcha: "Captcha girin", passwordHint: "En az 8 karakter",
    confirmPassword: "Şifreyi onayla", reenterPassword: "Şifreyi tekrar girin",
    createAccount: "Hesap oluştur", creatingAccount: "Hesap oluşturuluyor…",
    noAccount: "Hesabınız yok mu?", haveAccount: "Hesabınız var mı?",
    fillRequired: "Lütfen tüm gerekli alanları doldurun.", emailPwRequired: "E-posta ve şifre gereklidir.",
    pwMin: "Şifre en az 8 karakter olmalıdır.", pwMismatch: "Şifreler eşleşmiyor.",
    captchaMismatch: "Captcha eşleşmiyor.",
    kyc: "KYC Doğrulama", bindAccount: "Hesap bağla", orders: "Emirler", deposit: "Yatırma",
    withdraw: "Çekme", history: "Geçmiş", notifications: "Bildirimler",
    onlineService: "Çevrimiçi servis", aboutUs: "Hakkımızda", help: "Yardım",
    verified: "Doğrulandı", pendingReview: "İnceleniyor", notVerified: "Doğrulanmadı",
    completeKyc: "Tüm özellikleri açmak için KYC doğrulamasını tamamlayın.",
    demoNoFeatures: "Demo hesaplar bu özellikleri kullanamaz.", back: "Geri",
  },
