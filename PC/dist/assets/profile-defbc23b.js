import{o as s,F as V,u as c,i as $,p as K,A as h,j as o,q as H,k as O,n as e,G as u,C as P}from"./index-1271e741.js";import{I as W}from"./I18nSelect-403f741a.js";import{u as Y}from"./useDispatch-8152c815.js";import"./layoutActions-62cf3707.js";const G=[{icon:"fas fa-language",name:s("pages.settings.language"),type:"modal",modal:"language"},{icon:"fas fa-shield-alt",path:"/typepassword",name:s("pages.profile.menu.password"),requiresKyc:!0},{icon:"fas fa-file-alt",path:"/history",name:s("pages.profile.menu.withdrawalAddress"),requiresKyc:!0},{icon:"fas fa-bell",path:"/notification",name:s("pages.profile.menu.notifications")},{icon:"fas fa-comment-dots",path:"/online-service",name:s("pages.profile.menu.customerSupport")},{icon:"fas fa-building",path:"/about",name:s("pages.profile.menu.aboutUs")},{icon:"fas fa-question-circle",path:"/support",name:s("pages.profile.menu.helpcenter")},{icon:"fas fa-download",path:"/download",name:s("pages.profile.menu.downloadApp")},{icon:"fas fa-trash-alt",name:s("pages.profile.menu.clearCache"),type:"action"}];function X(){const l=Y(),m=V(),n=c($.selectCurrentUser),i=c(K.selectKycStatus),x=c(h.selectLoading),w=c(h.selectTotalFiat),[d,y]=o.useState(!1),[k,g]=o.useState(!1),b=o.useMemo(()=>i==="success",[i]),p=o.useMemo(()=>({user:n}),[n]);o.useEffect(()=>{l(H.doFetch(p,p))},[l,p]),o.useEffect(()=>{let a=!0;return(async()=>{if(a)try{await l(P.doFetch(null,"USD"))}catch(r){a&&console.error(r)}})(),()=>{a=!1}},[l]);const j=o.useCallback(()=>l(O.doSignout()),[l]),N=o.useCallback(()=>y(a=>!a),[]),v=o.useCallback(()=>g(!0),[]),f=o.useCallback(()=>g(!1),[]),C=o.useCallback(()=>{alert(s("pages.profile.cache.cleared"))},[]),F=(n==null?void 0:n.fullName)||(n==null?void 0:n.email)||s("pages.profile.user"),E="ID: 1234 5678 9012",A=s("pages.wallet.totalUsdValue")||"Available Assets",z=a=>a==null?"0.00":a.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}),D=()=>{switch(i){case"success":return s("pages.profile.status.verified");case"pending":return s("pages.profile.verification.pending.status");default:return s("pages.profile.status.unverified")}},S=()=>{switch(i){case"success":return"fas fa-check-circle";case"pending":return"fas fa-clock";default:return"fas fa-exclamation-circle"}},M=()=>{switch(i){case"success":return s("pages.profile.status.verified");case"pending":return s("pages.profile.verification.pending.button");default:return s("pages.profile.verification.alert.verifyNow")}},I=()=>i==="success"||i==="pending",L=()=>i==="unverified",B=o.useMemo(()=>{let a=G.map(t=>({...t,disabled:(t==null?void 0:t.requiresKyc)&&!b}));return(n==null?void 0:n.accountType)==="demo"&&(a=a.map(t=>({...t,disabled:t.requiresKyc?!0:t.disabled}))),a},[b,n==null?void 0:n.accountType]),T=o.useCallback(()=>{i==="unverified"?m.push("/proof"):i==="pending"&&alert(s("pages.profile.verification.pendingAlert"))},[i,m]),q=(a,t)=>{if(a.type==="action")return e.jsxs("li",{className:"menu-item",onClick:C,children:[e.jsx("div",{className:"menu-icon-box",children:e.jsx("i",{className:a.icon})}),e.jsx("span",{className:"menu-label",children:a.name}),e.jsx("span",{className:"menu-arrow"})]},t);if(a.type==="modal")return e.jsxs("li",{className:`menu-item ${a.disabled?"disabled":""}`,onClick:v,children:[e.jsx("div",{className:"menu-icon-box",children:e.jsx("i",{className:a.icon})}),e.jsx("span",{className:"menu-label",children:a.name}),e.jsx("span",{className:"menu-arrow",children:e.jsx("i",{className:"fas fa-chevron-right"})})]},t);const r=e.jsxs("li",{className:`menu-item ${a.disabled?"disabled":""}`,children:[e.jsx("div",{className:"menu-icon-box",children:e.jsx("i",{className:a.icon})}),e.jsx("span",{className:"menu-label",children:a.name}),e.jsx("span",{className:"menu-arrow",children:!a.disabled&&e.jsx("i",{className:"fas fa-chevron-right"})})]});return a.disabled?e.jsx("div",{className:"menu-link-wrapper",children:r},a.name):e.jsx(u,{to:a.path,className:"menu-link-wrapper",children:r},a.name)};return e.jsxs("div",{className:"profile-page",children:[e.jsxs("div",{className:"balance-header-card",children:[e.jsxs("div",{className:"header-top-row",children:[e.jsxs("div",{children:[e.jsxs("h2",{className:"simulation-title",children:[F,(n==null?void 0:n.accountType)==="demo"&&e.jsx("span",{className:"demo-tag",children:"DEMO"})]}),e.jsx("p",{className:"account-id",children:E})]}),e.jsx("button",{className:"eye-toggle",onClick:N,children:e.jsx("i",{className:`fas ${d?"fa-eye-slash":"fa-eye"}`})})]}),e.jsx("div",{className:"balance-amount",children:x?e.jsx("div",{className:"skeleton-line amount-skel"}):d?"••••••":`$${z(w)}`}),e.jsx("p",{className:"balance-subtitle",children:x?e.jsx("div",{className:"skeleton-line sub-skel"}):d?"••••":A})]}),e.jsxs("div",{className:"action-buttons-section",children:[e.jsxs(u,{to:"/deposit",className:"action-btn deposit-btn",children:[e.jsx("i",{className:"fas fa-wallet"}),e.jsxs("div",{className:"btn-text-group",children:[e.jsx("span",{className:"btn-main-text",children:"Deposit"}),e.jsx("span",{className:"btn-sub-text",children:"Billing Details >>"})]})]}),e.jsxs(u,{to:"/withdraw",className:"action-btn withdraw-btn",children:[e.jsx("i",{className:"fas fa-money-bill-wave"}),e.jsxs("div",{className:"btn-text-group",children:[e.jsx("span",{className:"btn-main-text",children:"Withdraw"}),e.jsx("span",{className:"btn-sub-text",children:"Withdraw Details >>"})]})]})]}),e.jsxs("div",{className:"menu-section",children:[e.jsxs("ul",{className:"menu-list",children:[(n==null?void 0:n.accountType)!=="demo"&&e.jsxs("li",{className:"menu-item kyc-line",children:[e.jsx("div",{className:"menu-icon-box kyc-icon",children:e.jsx("i",{className:S()})}),e.jsx("span",{className:"menu-label",children:D()}),e.jsx("div",{className:"menu-action",children:e.jsx("button",{className:`kyc-button ${L()?"pulse":""}`,onClick:T,disabled:I(),children:M()})})]}),B.map((a,t)=>q(a,t))]}),e.jsxs("button",{className:"logout-btn",onClick:j,children:[e.jsx("i",{className:"fas fa-sign-out-alt"})," ",s("pages.profile.menu.logout")]})]}),k&&e.jsx("div",{className:"modal-overlay",onClick:f,children:e.jsxs("div",{className:"modal-container",onClick:a=>a.stopPropagation(),children:[e.jsxs("div",{className:"modal-header",children:[e.jsx("div",{className:"modal-handle"}),e.jsxs("div",{className:"modal-title-row",children:[e.jsx("span",{className:"modal-title-text",children:s("pages.settings.modals.language.title")}),e.jsx("button",{className:"modal-close",onClick:f,children:e.jsx("i",{className:"fas fa-times"})})]})]}),e.jsx("div",{className:"modal-body",children:e.jsx(W,{isInModal:!0})})]})}),e.jsx("style",{children:`
