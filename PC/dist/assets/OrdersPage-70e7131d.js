import{o as ee,p as se,i as c,I as k,j as s}from"./index-e7a2b935.js";import{u as te,a as ne,g as I,c as E,b as _}from"./useSymbolInjections-8b548024.js";const C=a=>`~m~${a.length}~m~${a}`;function ae(a){const r=[];let d=a;for(;d.length>0&&d.startsWith("~m~");){const g=d.indexOf("~m~",3),f=parseInt(d.substring(3,g));r.push(d.substring(g+3,g+3+f)),d=d.substring(g+3+f)}return r}function oe(a){try{return JSON.parse(a.replace(/^=\{/,"{")).symbol??a}catch{return a}}function u(a){return a==null?"—":a>=1e4?a.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}):a>=100?a.toFixed(2):a>=10?a.toFixed(3):a.toFixed(5)}function z(a){return`${a>=0?"+":""}${a.toFixed(2)}`}function v(a){if(!a)return"—";try{const r=new Date(a);return`${r.toLocaleDateString("en-GB",{day:"2-digit",month:"2-digit",year:"numeric"})} ${r.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}`}catch{return a}}function H(a,r){if(!a.entryPrice)return 0;const d=a.direction==="buy"?r-a.entryPrice:a.entryPrice-r;return parseFloat((d*a.lots*100-a.fee).toFixed(5))}const re=()=>{const a=ee(se.selectCurrentTenant),r=a==null?void 0:a.id,[d,g]=c.useState("positions"),[f,D]=c.useState([]),[G,X]=c.useState(!0),[Y,A]=c.useState(null),[K,B]=c.useState(null),[o,$]=c.useState(null),[h,Q]=c.useState({}),b=te(),y=c.useRef(null),U=c.useRef(null),P=c.useRef(new Set),L=c.useRef(null),W=c.useRef([]),O=c.useRef(new Set),R=c.useRef(new Set),x=c.useCallback(async()=>{if(r)try{const{data:e}=await k.get(`/tenant/${r}/trade-orders`);D((e==null?void 0:e.rows)??[])}catch{D([])}finally{X(!1)}},[r]);c.useEffect(()=>{x()},[x]),c.useEffect(()=>{const e=setInterval(()=>{x()},15e3);return()=>clearInterval(e)},[x]);const M=c.useCallback(e=>{const n=y.current,t=U.current;!n||n.readyState!==WebSocket.OPEN||!t||e.forEach(i=>{P.current.has(i)||(n.send(C(JSON.stringify({m:"quote_add_symbols",p:[t,i]}))),P.current.add(i))})},[]);c.useEffect(()=>{const e=[...new Set(f.filter(n=>n.status==="active"||n.status==="waiting").map(n=>n.symbol))];W.current=e,M(e)},[f,M]);const T=c.useCallback(()=>{y.current&&(y.current.close(),y.current=null);const e=new WebSocket(ne());y.current=e,e.onopen=()=>{const n="qs_"+Math.random().toString(36).substring(2,12);U.current=n,P.current=new Set,e.send(C(JSON.stringify({m:"quote_create_session",p:[n]}))),e.send(C(JSON.stringify({m:"quote_set_fields",p:[n,"lp","ask","bid"]}))),W.current.forEach(t=>{e.send(C(JSON.stringify({m:"quote_add_symbols",p:[n,t]}))),P.current.add(t)})},e.onmessage=n=>{const t=n.data;if(t.startsWith("~h~")){e.send(t);return}ae(t).forEach(i=>{try{const l=JSON.parse(i);if(l.m!=="qsd")return;const p=l.p[1],w=oe(p.n),m=p.v;if(!m)return;let N=null;typeof m.lp=="number"&&m.lp>0?N=m.lp:typeof m.ask=="number"&&typeof m.bid=="number"&&m.ask>0&&(N=(m.ask+m.bid)/2),N!==null&&Q(F=>F[w]===N?F:{...F,[w]:N})}catch{}})},e.onclose=n=>{n.wasClean||(L.current=setTimeout(T,3e3))},e.onerror=()=>{}},[]);c.useEffect(()=>(T(),()=>{var e;L.current&&clearTimeout(L.current),(e=y.current)==null||e.close()}),[T]),c.useEffect(()=>{if(!r)return;const e=f.filter(t=>t.status==="active"),n=f.filter(t=>t.status==="waiting");e.forEach(t=>{const i=h[t.symbol];if(i==null)return;const l=t.id||t._id;if(O.current.has(l)||b[t.symbol])return;let p=null;t.takeProfit&&(t.direction==="buy"&&i>=t.takeProfit&&(p="tp"),t.direction==="sell"&&i<=t.takeProfit&&(p="tp")),!p&&t.stopLoss&&(t.direction==="buy"&&i<=t.stopLoss&&(p="sl"),t.direction==="sell"&&i>=t.stopLoss&&(p="sl")),p&&(O.current.add(l),k.put(`/tenant/${r}/trade-orders/${l}/close`,{closePrice:i,closeReason:p}).then(()=>x()).finally(()=>O.current.delete(l)))}),n.forEach(t=>{const i=h[t.symbol];if(i==null||t.targetPrice==null)return;const l=t.id||t._id;if(R.current.has(l))return;(t.triggerAbove?i>=t.targetPrice:i<=t.targetPrice)&&(R.current.add(l),k.put(`/tenant/${r}/trade-orders/${l}/execute`,{executionPrice:i}).then(()=>x()).finally(()=>R.current.delete(l)))})},[h,f,r,x,b]);const V=c.useCallback(async e=>{if(!r)return;const n=h[e.symbol],t=b[e.symbol],i=t&&n!=null?I(t):n;if(i==null)return;const l=e.id||e._id;A(l);try{await k.put(`/tenant/${r}/trade-orders/${l}/close`,{closePrice:i,closeReason:"manual"}),await x()}catch{alert("Failed to close position. Please try again.")}finally{A(null)}},[r,h,x,b]),Z=c.useCallback(async e=>{if(!r)return;const n=e.id||e._id;B(n);try{await k.put(`/tenant/${r}/trade-orders/${n}/cancel`),await x()}catch{alert("Failed to cancel order. Please try again.")}finally{B(null)}},[r,x]),j=f.filter(e=>e.status==="active"),S=f.filter(e=>e.status==="waiting"),q=f.filter(e=>e.status==="closed"||e.status==="cancelled"),J=j.reduce((e,n)=>{const t=b[n.symbol],i=h[n.symbol]??null,l=t&&i!==null?I(t):i;return e+(l!=null?H(n,l):0)},0);return s.jsxs(s.Fragment,{children:[s.jsx("style",{children:ie}),s.jsxs("div",{className:"op-page",children:[s.jsx("div",{className:"op-header",children:s.jsx("div",{className:"op-title",children:"Orders"})}),s.jsxs("div",{className:"op-card",children:[s.jsxs("div",{className:"op-tabs",children:[s.jsxs("button",{className:`op-tab ${d==="positions"?"active":""}`,onClick:()=>g("positions"),children:["Positions",j.length>0&&s.jsx("span",{className:"op-badge",children:j.length})]}),s.jsxs("button",{className:`op-tab ${d==="pending"?"active":""}`,onClick:()=>g("pending"),children:["Pending",S.length>0&&s.jsx("span",{className:"op-badge",children:S.length})]}),s.jsx("button",{className:`op-tab ${d==="history"?"active":""}`,onClick:()=>g("history"),children:"History"})]}),G?s.jsx("div",{className:"op-skeleton-list",children:[1,2,3].map(e=>s.jsx("div",{className:"op-skeleton-row"},e))}):d==="positions"?s.jsxs(s.Fragment,{children:[j.length>0&&s.jsxs("div",{className:"op-summary",children:[s.jsx("span",{className:"op-summary-label",children:"Floating P&L"}),s.jsx("span",{className:`op-summary-val ${J>=0?"green":"red"}`,children:z(J)})]}),j.length===0?s.jsx("div",{className:"op-empty",children:"No open positions"}):j.map(e=>{const n=e.id||e._id,t=b[e.symbol],i=h[e.symbol]??null,l=t&&i!==null?I(t):i,p=l!=null?H(e,l):null,w=Y===n,m=E(e.symbol)??{symbol:e.symbol,name:e.symbol};return s.jsxs("div",{className:"op-order-card",children:[s.jsxs("div",{className:"op-order-top",children:[s.jsxs("div",{className:"op-order-left",children:[s.jsx(_,{pair:m,size:"sm"}),s.jsx("span",{className:"op-sym",children:e.symbol}),e.orderType==="pending"&&s.jsx("span",{className:"op-tag op-tag-executed",children:"Executed"})]}),s.jsxs("div",{className:"op-badges",children:[s.jsx("span",{className:`op-dir ${e.direction}`,children:e.direction==="buy"?"Buy":"Sell"}),s.jsxs("span",{className:"op-lots",children:[e.lots," Lots"]}),s.jsxs("span",{className:"op-lots",children:[e.multiplier,"×"]})]})]}),s.jsxs("div",{className:"op-price-row",children:[s.jsx("span",{className:"op-open-price",children:u(e.entryPrice)}),s.jsx("span",{className:"op-arrow",children:"→"}),l!=null?s.jsx("span",{className:"op-live-price",children:u(l)}):s.jsx("span",{className:"op-price-loading",children:s.jsx("span",{className:"op-dot-pulse"})})]}),(e.takeProfit||e.stopLoss)&&s.jsxs("div",{className:"op-sltp-row",children:[e.takeProfit&&s.jsxs("span",{className:"op-tp",children:["TP: ",u(e.takeProfit)]}),e.stopLoss&&s.jsxs("span",{className:"op-sl",children:["SL: ",u(e.stopLoss)]})]}),s.jsxs("div",{className:"op-order-footer",children:[s.jsxs("div",{className:"op-footer-left",children:[s.jsx("span",{className:`op-pnl ${p==null?"muted":p>=0?"green":"red"}`,children:p!=null?z(p):"—"}),s.jsx("span",{className:"op-date",children:v(e.openTime??e.createdAt)})]}),s.jsx("button",{className:"op-close-btn",onClick:()=>V(e),disabled:w||l==null,children:w?"Closing…":"Close Position"})]})]},n)})]}):d==="pending"?s.jsx(s.Fragment,{children:S.length===0?s.jsx("div",{className:"op-empty",children:"No pending orders"}):S.map(e=>{const n=e.id||e._id,t=h[e.symbol]??null,i=K===n,l=E(e.symbol)??{symbol:e.symbol,name:e.symbol},p=e.targetPrice&&e.referencePrice&&t!=null?(Math.abs(e.targetPrice-t)/e.referencePrice*100).toFixed(2):null;return s.jsxs("div",{className:"op-order-card",children:[s.jsxs("div",{className:"op-order-top",children:[s.jsxs("div",{className:"op-order-left",children:[s.jsx(_,{pair:l,size:"sm"}),s.jsx("span",{className:"op-sym",children:e.symbol}),s.jsx("span",{className:"op-tag op-tag-waiting",children:"Waiting"})]}),s.jsxs("div",{className:"op-badges",children:[s.jsx("span",{className:`op-dir ${e.direction}`,children:e.direction==="buy"?"Buy":"Sell"}),s.jsxs("span",{className:"op-lots",children:[e.lots," Lots"]}),s.jsxs("span",{className:"op-lots",children:[e.multiplier,"×"]})]})]}),s.jsxs("div",{className:"op-pending-prices",children:[s.jsxs("div",{className:"op-pending-row",children:[s.jsx("span",{className:"op-pending-label",children:"Trigger at"}),s.jsx("span",{className:"op-pending-target",children:u(e.targetPrice)})]}),s.jsxs("div",{className:"op-pending-row",children:[s.jsx("span",{className:"op-pending-label",children:"Current price"}),t!=null?s.jsx("span",{className:"op-live-price",children:u(t)}):s.jsx("span",{className:"op-price-loading",children:s.jsx("span",{className:"op-dot-pulse"})})]}),p&&s.jsxs("div",{className:"op-pending-row",children:[s.jsx("span",{className:"op-pending-label",children:"Distance"}),s.jsxs("span",{className:"op-pending-dist",children:[p,"%"]})]})]}),(e.takeProfit||e.stopLoss)&&s.jsxs("div",{className:"op-sltp-row",children:[e.takeProfit&&s.jsxs("span",{className:"op-tp",children:["TP: ",u(e.takeProfit)]}),e.stopLoss&&s.jsxs("span",{className:"op-sl",children:["SL: ",u(e.stopLoss)]})]}),s.jsxs("div",{className:"op-order-footer",children:[s.jsx("div",{className:"op-footer-left",children:s.jsx("span",{className:"op-date",children:v(e.createdAt)})}),s.jsx("button",{className:"op-cancel-btn",onClick:()=>Z(e),disabled:i,children:i?"Cancelling…":"Cancel Order"})]})]},n)})}):q.length===0?s.jsx("div",{className:"op-empty",children:"No order history yet"}):q.map(e=>{const n=e.id||e._id,t=e.pnl??0,i=E(e.symbol)??{symbol:e.symbol,name:e.symbol};return s.jsxs("div",{className:"op-history-card",onClick:()=>$(e),children:[s.jsxs("div",{className:"op-order-top",children:[s.jsxs("div",{className:"op-order-left",children:[s.jsx(_,{pair:i,size:"sm"}),s.jsx("span",{className:"op-sym",children:e.symbol}),e.status==="cancelled"&&s.jsx("span",{className:"op-tag op-tag-cancelled",children:"Cancelled"})]}),e.status!=="cancelled"&&s.jsx("span",{className:`op-pnl ${t>=0?"green":"red"}`,children:z(t)})]}),s.jsxs("div",{className:"op-price-row",children:[s.jsx("span",{className:"op-open-price",children:u(e.entryPrice)}),e.status!=="cancelled"&&e.closePrice&&s.jsxs(s.Fragment,{children:[s.jsx("span",{className:"op-arrow",children:"→"}),s.jsx("span",{className:"op-live-price",children:u(e.closePrice)})]})]}),s.jsxs("div",{className:"op-hist-meta",children:[s.jsx("span",{className:`op-dir ${e.direction}`,children:e.direction==="buy"?"Buy":"Sell"}),s.jsxs("span",{children:[e.lots," Lots · ",e.multiplier,"×"]}),e.closeReason&&e.closeReason!=="manual"&&s.jsx("span",{className:`op-close-reason op-cr-${e.closeReason}`,children:e.closeReason.toUpperCase()}),s.jsx("span",{children:v(e.closeTime??e.createdAt)})]})]},n)})]})]}),o&&s.jsxs(s.Fragment,{children:[s.jsx("div",{className:"op-overlay",onClick:()=>$(null)}),s.jsxs("div",{className:"op-detail-sheet",children:[s.jsx("div",{className:"op-detail-handle"}),s.jsx("button",{className:"op-detail-x",onClick:()=>$(null),children:"✕"}),s.jsx("div",{className:"op-detail-heading",children:"Order Details"}),[["Pair",o.symbol],["Direction",o.direction==="buy"?"Buy":"Sell",o.direction],["Order Type",o.orderType==="market"?"Market":"Pending"],["Status",o.status.charAt(0).toUpperCase()+o.status.slice(1)],["Lots",String(o.lots)],["Multiplier",`${o.multiplier}×`],["Margin",`$${(o.margin??0).toFixed(2)}`],["Fee",`$${(o.fee??0).toFixed(5)}`],o.entryPrice?["Open Price",u(o.entryPrice)]:null,o.closePrice?["Close Price",u(o.closePrice)]:null,o.targetPrice?["Trigger Price",u(o.targetPrice)]:null,o.status!=="cancelled"&&o.pnl!=null?["P&L",z(o.pnl),o.pnl>=0?"buy":"sell"]:null,o.takeProfit?["Take Profit",u(o.takeProfit)]:null,o.stopLoss?["Stop Loss",u(o.stopLoss)]:null,o.closeReason?["Close Reason",o.closeReason.toUpperCase()]:null,["Order #",o.orderNumber],["Opened",v(o.openTime??o.createdAt)],o.closeTime?["Closed",v(o.closeTime)]:null].filter(Boolean).map(([e,n,t])=>s.jsxs("div",{className:"op-detail-row",children:[s.jsx("span",{className:"op-detail-label",children:e}),s.jsx("span",{className:`op-detail-val ${t==="buy"?"green":t==="sell"?"red":""}`,children:n})]},e))]})]})]})},ie=`
